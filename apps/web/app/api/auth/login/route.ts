...
function mapCodeToStatus(code: "invalid_credentials" | "inactive_tenant" | "inactive_user" | "web_access_denied"): number {
  switch (code) {
...
export async function POST(
  ...
  const service = context?.service ?? buildLoginService();
  let payload: unknown;
